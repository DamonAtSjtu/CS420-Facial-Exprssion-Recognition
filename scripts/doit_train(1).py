...
net.load_state_dict(torch.load('./FER2013_VGG19_new1/PublicTest_ad251_model.t7', map_location='cpu')['net'])
net1 = VGG('VGG19')
net1.load_state_dict(torch.load('./FER2013_VGG19_new1/PublicTest_ad251_model.t7', map_location='cpu')['net'])
if use_cuda:
    net1.cuda()
net2 = ResNet18()
net2.load_state_dict(torch.load('./FER2013_Resnet18_originfinal/PrivateTest_model.t7', map_location='cpu')['net'])
if use_cuda:
    net2.cuda()
print("==> Just DO ITT!")
